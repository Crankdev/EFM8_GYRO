...
extern void SPI_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	 // CKPHA (SPI0 Clock Phase) = DATA_CENTERED_SECOND (Data centered on
	 //     second edge of SCK period.)
	 // CKPOL (SPI0 Clock Polarity) = IDLE_HIGH (SCK line high in idle state.)
	 */
...
extern void SPI_1_enter_DefaultMode_from_RESET(void) {
	...
	/*
	 // SPI1CKR (SPI1 Clock Rate) = 0x07
	 */
	SPI1CKR = (0x07 << SPI1CKR_SPI1CKR__SHIFT);
	// [SPI1CKR - SPI1 Clock Rate]$

	// $[SPI1CFG - SPI1 Configuration]
	/*
	 // CKPHA (SPI1 Clock Phase) = DATA_CENTERED_SECOND (Data centered on
	 //     second edge of SCK period.)
	 // CKPOL (SPI1 Clock Polarity) = IDLE_HIGH (SCK line high in idle state.)
	 */
	SPI1CFG |= SPI1CFG_CKPHA__DATA_CENTERED_SECOND | SPI1CFG_CKPOL__IDLE_HIGH;
	// [SPI1CFG - SPI1 Configuration]$
...
extern void INTERRUPT_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	 ...
	 // PRTC0F (RTC Oscillator Fail Interrupt Priority Control) = LOW (RTC
	 //     Oscillator Fail interrupt set to low priority level.)
	 // PSPI1 (Serial Peripheral Interface (SPI1) Interrupt Priority Control)
	 //     = HIGH (SPI1 interrupt set to high priority level.)
	 // PWARN (Supply Monitor Early Warning Interrupt Priority Control) = LOW
	 //     (Supply Monitor Early Warning interrupt set to low priority level.)
	 */
	EIP2 = EIP2_PMAT__LOW | EIP2_PRTC0F__LOW | EIP2_PSPI1__HIGH
			| EIP2_PWARN__LOW;
	// [EIP2 - Extended Interrupt Priority 2]$
